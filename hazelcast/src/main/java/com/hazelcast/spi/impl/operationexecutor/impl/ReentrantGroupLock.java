...
final class ReentrantGroupLock {
   ...
   //TODO preferred byte array counter to reduce memory footprint
   ...
   public boolean tryLock(final int index) {
      ...
      if (groupAccessCount > 0) {
         ...
         //TODO MEASURE!! try to perform a wait-free (if supported) atomic increment -> could scale better
